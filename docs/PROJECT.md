...
| Document | Contains |
|---|---|
| `DECISIONS.md` | K1–K46: every architectural decision, its rationale and its cost |
...
| **M6** 🔨 | Strategy + risk + alerting | Strategy-level net delta; thresholds with hysteresis and cooldown; Telegram/webhook; SSE; dashboard v1 — planned: `docs/plans/2026-09-10-m6-strategy-risk-alerting.md` |
